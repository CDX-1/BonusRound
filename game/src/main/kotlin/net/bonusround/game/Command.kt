...
object BonusRoundCommandList : MutableMap<String, net.bonusround.game.Command> by hashMapOf()
...
abstract class Command(
    ...
    val subcommands: MutableList<out net.bonusround.game.Command> = mutableListOf(),
    ...
    fun register() {
        net.bonusround.game.BonusRoundCommandList[name] = this
        aliases.forEach { alias ->
            net.bonusround.game.BonusRoundCommandList[alias] = this
        }
        val command = getCommand()
        command.register(net.bonusround.game.Main.Companion.instance)
    }
